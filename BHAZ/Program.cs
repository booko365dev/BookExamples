...
//gavdcodebegin 001
static void PowerPointOpenXml_CreatePresentation()
{
...
//gavdcodebegin 002
static void PPCreateDefaultSlide(PresentationPart PPPresentationPart)
{
...
//gavdcodebegin 003
static SlidePart PPCreateSlidePart(PresentationPart PPPresentationPart)
{
...
//gavdcodebegin 005
static SlideMasterPart PPCreateSlideMasterPart(SlideLayoutPart PPSlideLayoutPart)
{
    SlideMasterPart mySlideMasterPart =
...
//gavdcodebegin 007
static void PowerPointOpenXml_FindTextInSlide()
{
    using PresentationDocument myPowerPointDoc =
...
//gavdcodebegin 010
static void PowerPointOpenXml_FindAllTextInOneSlide()
{
    ...
    if (myPresentationPart != null && myPresentationPart.Presentation != null)
    {
        Presentation myPresentation = myPresentationPart.Presentation;

        if (myPresentation.SlideIdList != null)
        {
            OpenXmlElementList allSlideIds = myPresentation.SlideIdList.ChildElements;
            ...
            if (toFindTextInSlidePositionIndex < allSlideIds.Count)
            {
                ...
                SlidePart mySlidePart =
                    (SlidePart)myPresentationPart.GetPartById(mySlidePartRelationshipId);
...
//gavdcodebegin 011
static void PowerPointOpenXml_FindAllSlideTitles()
{
    using PresentationDocument myPowerPointDoc =
 ...
 static bool IsTitleShape(P.Shape ShapeToSearch)
{
...
//gavdcodebegin 008
static void PowerPointOpenXml_CopyTheme()
{
    ...
    PresentationPart myPresentationPart = myPowerPointDoc.PresentationPart;
    SlideMasterPart mySlideMasterPart = myPresentationPart.SlideMasterParts.ElementAt(0);
    string myRelationshipId = myPresentationPart.GetIdOfPart(mySlideMasterPart);
    ...
    foreach (SlidePart oneSlidePart in myPresentationPart.SlideParts)
    {
        ...
        {
            layoutType = oneSlidePart.SlideLayoutPart.SlideLayout.CommonSlideData.Name;
...
//gavdcodebegin 009
static void PowerPointOpenXml_InsertNewSlide()
{
    ...
    P.NonVisualGroupShapeProperties myNonVisualProperties =
                newSlide.CommonSlideData.ShapeTree.AppendChild(
                    new P.NonVisualGroupShapeProperties());
    myNonVisualProperties.NonVisualDrawingProperties = new P.NonVisualDrawingProperties()
                    {
                        Id = 1,
                        Name = ""
                    };
    ...
    newSlide.CommonSlideData.ShapeTree.AppendChild(new GroupShapeProperties());
    P.Shape myTitleShape = newSlide.CommonSlideData.ShapeTree.AppendChild(new P.Shape());
    drawingObjectId++;
    ...
    P.Shape myBodyShape = newSlide.CommonSlideData.ShapeTree.AppendChild(new P.Shape());
    drawingObjectId++;
...
//gavdcodebegin 012
static void PowerPointOpenXml_FindNumberOfSlides(bool includeHidden = true)
{
    using PresentationDocument myPowerPointDoc =
         PresentationDocument.Open(@"C:\Temporary\PowerPointDoc01.pptx", false);
    ...
    if (myPresentationPart != null)
    {
        ...
        Console.WriteLine("Only visible slides: " + allSlides.Count().ToString());
    }
}
//gavdcodeend 012

//gavdcodebegin 013
static void PowerPointOpenXml_MoveSlide()
{
    ...
    SlideId sourceSlide = mySlideIdList.ChildElements[slideIndexFrom] as SlideId;
    ...
    {
        targetSlide = mySlideIdList.ChildElements[slideIndexTo - 1] as SlideId;
    }
...
//gavdcodebegin 014
static void PowerPointOpenXml_DeleteOneSlide()
{
    int slideIndex = 1;
...
//gavdcodebegin 015
static void PowerPointOpenXml_AddCommentToSlide()
{
    ...
    {
        myCommentAuthorsPart = myPowerPointDoc.PresentationPart.CommentAuthorsPart;
    }
    ...
    {
        mySlideCommentsPart = mySlidePart.GetPartsOfType<SlideCommentsPart>().First();
    }
...
//gavdcodebegin 016
static void PowerPointOpenXml_RemoveAllCommentsAuthor()
{
    string myAuthorName = "Gustavo Velez";
    ...
    foreach (CommentAuthor oneCommentAuthor in myCommentAuthors)
    {
                            ...
                            myPowerPointDoc.PresentationPart.SlideParts)
        {
                ...
                oneSlidePart.SlideCommentsPart.CommentList != null)
            {
                ...
                {
                    mySlideCommentsPart.CommentList.RemoveChild<Comment>(oneComment);
                }
...
//gavdcodebegin 017
static void PowerPointOpenXml_AddNotesToSlide()
{
    ...
    SlideId mySlideId = myPresentationPart.Presentation.SlideIdList.
                                               GetFirstChild<SlideId>();
    string myRelationshipId = mySlideId.RelationshipId;
    SlidePart mySlidePart = (SlidePart)myPresentationPart.GetPartById(myRelationshipId);
...
//gavdcodebegin 018
static void PowerPointOpenXml_FindTextInNotes()
{
    using PresentationDocument myPowerPointDoc =
         PresentationDocument.Open(@"C:\Temporary\PowerPointDoc01.pptx", false);
...
//gavdcodebegin 019
static void PowerPointOpenXml_AddImageToSlide()
{
    ...
    Presentation myPresentation = myPresentationPart.Presentation;
    SlidePart mySlidePart = myPresentation.PresentationPart.SlideParts.First();
    ...
    myPicture.NonVisualPictureProperties.Append(myNonVisualPictureDrawingProp);
    myPicture.NonVisualPictureProperties.Append(
    ...
    var myUseLocalDpi = new DocumentFormat.OpenXml.Office2010.Drawing.UseLocalDpi()
    {
        Val = false
    };
...
//gavdcodebegin 020
static void PowerPointOpenXml_AddShapeToSlide()
{
    using PresentationDocument myPowerPointDoc =
         PresentationDocument.Open(@"C:\Temporary\PowerPointDoc01.pptx", true);
...
//PowerPointOpenXml_CreatePresentation();
//PowerPointOpenXml_FindTextInSlide();
//PowerPointOpenXml_FindAllTextInOneSlide();
//PowerPointOpenXml_FindAllSlideTitles();
//PowerPointOpenXml_CopyTheme();
//PowerPointOpenXml_InsertNewSlide();
//PowerPointOpenXml_FindNumberOfSlides();
//PowerPointOpenXml_MoveSlide();
//PowerPointOpenXml_DeleteOneSlide();
//PowerPointOpenXml_AddCommentToSlide();
//PowerPointOpenXml_RemoveAllCommentsAuthor();
//PowerPointOpenXml_AddNotesToSlide();
//PowerPointOpenXml_FindTextInNotes();
//PowerPointOpenXml_AddImageToSlide();
//PowerPointOpenXml_AddShapeToSlide();
