...
//gavdcodebegin 001
static void ExcelEpplus_CreateDocument()
{
    ...
    ExcelWorksheet myWorksheet = excelPackage.Workbook.Worksheets.Add("NewSheet");
...
//gavdcodebegin 002
static void ExcelEpplus_ReadSpreedshet()
{
    FileInfo myFileInfo = new FileInfo(@"C:\Temporary\ExcelEPPlus01.xlsx");
    ...
    ExcelWorksheet namedWorksheet = excelPackage.Workbook.Worksheets["NewSheet"];

    // Get a WorkSheet by name using LINQ
    ExcelWorksheet anotherWorksheet =
        excelPackage.Workbook.Worksheets.FirstOrDefault(ws => ws.Name == "NewSheet");
...
//gavdcodebegin 003
static void ExcelEpplus_UpdateCellValue()
{
    FileInfo myFileInfo = new FileInfo(@"C:\Temporary\ExcelEPPlus01.xlsx");
...
//gavdcodebegin 004
static void ExcelEpplus_InsertLineChart()
{
    FileInfo myFileInfo = new FileInfo(@"C:\Temporary\ExcelEPPlus01.xlsx");

    using ExcelPackage excelPackage = new ExcelPackage(myFileInfo);
    // Create a WorkSheet
    ExcelWorksheet myWorksheet = excelPackage.Workbook.Worksheets.Add("LineChartSheet");
...
//gavdcodebegin 005
static void ExcelEpplus_InsertPieChart()
{
    FileInfo myFileInfo = new FileInfo(@"C:\Temporary\ExcelEPPlus01.xlsx");

    using ExcelPackage excelPackage = new ExcelPackage(myFileInfo);
    // Create a WorkSheet
    ExcelWorksheet myWorksheet = excelPackage.Workbook.Worksheets.Add("PieChartSheet");
...
//gavdcodebegin 006
static void ExcelEpplus_StyleSheet()
{
    FileInfo myFileInfo = new FileInfo(@"C:\Temporary\ExcelEPPlus01.xlsx");

    using ExcelPackage excelPackage = new ExcelPackage(myFileInfo);
    // Create the WorkSheet
    ExcelWorksheet myWorksheet = excelPackage.Workbook.Worksheets.Add("StyleSheet");
    ...
    myWorksheet.Column(8).Style.HorizontalAlignment = ExcelHorizontalAlignment.Right;
    myWorksheet.Column(8).Style.VerticalAlignment = ExcelVerticalAlignment.Top;

    // Get the image from disk
    string myImage = @"C:\Temporary\MyImage.gif";
    ExcelPicture myExcelImage = myWorksheet.Drawings.AddPicture("My Logo", myImage);
...
//gavdcodebegin 007
static void ExcelEpplus_AddFormules()
{
    FileInfo myFileInfo = new FileInfo(@"C:\Temporary\ExcelEPPlus01.xlsx");
    ...
    // Create the WorkSheet
    ExcelWorksheet worksheet = excelPackage.Workbook.Worksheets.Add("FormuleSheet");
...
//ExcelEpplus_CreateDocument();
//ExcelEpplus_ReadSpreedshet();
//ExcelEpplus_UpdateCellValue();
//ExcelEpplus_InsertLineChart();
//ExcelEpplus_InsertPieChart();
//ExcelEpplus_StyleSheet();
//ExcelEpplus_AddFormules();
